...
# Run to equilibrium
sim <- project(params, effort = 1, t_max = 200, dt=0.1)
...
effort_Fhistsoc<-readRDS("FishingEffort.RDS")
...
for (t in (times - 1349)) {
	if (t <= 601) { 
		...
		effort_array_Fhistsoc[t,] <- effort_Fhistsoc[t - 600]
		effort_array_Fnat[t,] <- 0
		}
}
...
## PLANKTON SHOULD NOT EXTEND ALL THE WAY ALONG THE SPECTRUM
```
