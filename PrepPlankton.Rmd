...
[Modified from Phoebe Woodworth -Jefcoat's Hawaii longline example]
...
#### NEED TO WORK OUT WHAT THE AREA IS?
#area = 20527092 * 10^6

#### I used total volume of 5.5e13 for North Sea, in cubic metres (Andersen & Ursin 1977) * conversion to grams ww

area = 5.5e13* 10^6


# Load data (files downloaded in reaslly useful standard naming convention by Ryan Heneghan) - here we use the North Sea data - replace Hawaii_ with North_Sea_

GFDL_picon <- read.csv("North_Sea_GFDL-ESM4_picontrol_annual_1601_2100.csv", header = TRUE)
GFDL_hist <- read.csv("North_Sea_GFDL-ESM4_historical_annual_1850_2014.csv", header = TRUE)
GFDL_ssp126 <- read.csv("North_Sea_GFDL-ESM4_ssp126_annual_2015_2100.csv", header = TRUE)
GFDL_ssp585 <- read.csv("North_Sea_GFDL-ESM4_ssp585_annual_2015_2100.csv", header = TRUE)

IPSL_picon <- read.csv("North_Sea_IPSL-CM6A-LR_picontrol_annual_1601_2100.csv", header = TRUE)
IPSL_hist <- read.csv("North_Sea_IPSL-CM6A-LR_historical_annual_1850_2014.csv", header = TRUE)
IPSL_ssp126 <- read.csv("North_Sea_IPSL-CM6A-LR_ssp126_annual_2015_2100.csv", header = TRUE)
IPSL_ssp585 <- read.csv("North_Sea_IPSL-CM6A-LR_ssp585_annual_2015_2100.csv", header = TRUE)
...
species_params <- read.csv('nsparams.csv')[,-1]
...
# Create the params object - check kappa is based on Spence et al 2016  value
...
int_min <- min(GFDL_picon_coefs[,1],GFDL_hist_coefs[,1],GFDL_ssp126_coefs[,1],GFDL_ssp585_coefs[,1],IPSL_picon_coefs[,1], IPSL_hist_coefs[,1],IPSL_ssp126_coefs[,1],IPSL_ssp585_coefs[,1])
int_max <- max(GFDL_picon_coefs[,1],GFDL_hist_coefs[,1],GFDL_ssp126_coefs[,1],GFDL_ssp585_coefs[,1],IPSL_picon_coefs[,1], IPSL_hist_coefs[,1],IPSL_ssp126_coefs[,1],IPSL_ssp585_coefs[,1])


plot(picon_times, GFDL_picon_coefs[,1], type = "l", col = "black", xlim = c(1950, 2100), ylim = c(int_min,int_max), xlab = " ", ylab = " ")
par(new = TRUE)
plot(hist_times, GFDL_hist_coefs[,1], type = "l", col = "grey", xlim = c(1950, 2100), ylim = c(int_min,int_max), xlab = " ", ylab = " ")
par(new = TRUE)
plot(ssp_times, GFDL_ssp126_coefs[,1], type = "l", col = "cyan", xlim = c(1950, 2100), ylim = c(int_min,int_max), xlab = " ", ylab = " ")
par(new = TRUE)
plot(ssp_times, GFDL_ssp585_coefs[,1], type = "l", col = "blue", xlim = c(1950, 2100), ylim = c(int_min,int_max), xlab = " ", ylab = "Intercept")

plot(picon_times, IPSL_picon_coefs[,1], type = "l", col = "black", xlim = c(1950, 2100), ylim = c(int_min,int_max), xlab = " ", ylab = " ")
par(new = TRUE)
plot(hist_times, IPSL_hist_coefs[,1], type = "l", col = "grey", xlim = c(1950, 2100), ylim = c(int_min,int_max), xlab = " ", ylab = " ")
par(new = TRUE)
plot(ssp_times, IPSL_ssp126_coefs[,1], type = "l", col = "cyan", xlim = c(1950, 2100), ylim = c(int_min,int_max), xlab = " ", ylab = " ")
par(new = TRUE)
plot(ssp_times, IPSL_ssp585_coefs[,1], type = "l", col = "blue", xlim = c(1950, 2100), ylim = c(int_min,int_max), xlab = " ", ylab = "Intercept")


slope_min <- min(GFDL_picon_coefs[,2],GFDL_hist_coefs[,2],GFDL_ssp126_coefs[,2],GFDL_ssp585_coefs[,2],IPSL_picon_coefs[,2], IPSL_hist_coefs[,2],IPSL_ssp126_coefs[,2],IPSL_ssp585_coefs[,2])
slope_max <- max(GFDL_picon_coefs[,2],GFDL_hist_coefs[,2],GFDL_ssp126_coefs[,2],GFDL_ssp585_coefs[,2],IPSL_picon_coefs[,2], IPSL_hist_coefs[,2],IPSL_ssp126_coefs[,2],IPSL_ssp585_coefs[,2])



plot(picon_times, GFDL_picon_coefs[,2], type = "l", col = "black", xlim = c(1950, 2100), ylim = c(slope_min ,slope_max), xlab = " ", ylab = " ")
par(new = TRUE)
plot(hist_times, GFDL_hist_coefs[,2], type = "l", col = "grey", xlim = c(1950, 2100), ylim = c(slope_min ,slope_max), xlab = " ", ylab = " ")
par(new = TRUE)
plot(ssp_times, GFDL_ssp126_coefs[,2], type = "l", col = "cyan", xlim = c(1950, 2100), ylim = c(slope_min ,slope_max), xlab = " ", ylab = " ")
par(new = TRUE)
plot(ssp_times, GFDL_ssp585_coefs[,2], type = "l", col = "blue", xlim = c(1950, 2100), ylim = c(slope_min ,slope_max), xlab = " ", ylab = "Slope")

plot(picon_times, IPSL_picon_coefs[,2], type = "l", col = "black", xlim = c(1950, 2100), ylim = c(slope_min ,slope_max), xlab = " ", ylab = " ")
par(new = TRUE)
plot(hist_times, IPSL_hist_coefs[,2], type = "l", col = "grey", xlim = c(1950, 2100), ylim = c(slope_min ,slope_max), xlab = " ", ylab = " ")
par(new = TRUE)
plot(ssp_times, IPSL_ssp126_coefs[,2], type = "l", col = "cyan", xlim = c(1950, 2100), ylim = c(slope_min ,slope_max), xlab = " ", ylab = " ")
par(new = TRUE)
plot(ssp_times, IPSL_ssp585_coefs[,2], type = "l", col = "blue", xlim = c(1950, 2100), ylim = c(slope_min ,slope_max), xlab = " ", ylab = "Slope")


## Note in mizer slope values need to be 02, ensure conversion to nromalised desnity is carried out
