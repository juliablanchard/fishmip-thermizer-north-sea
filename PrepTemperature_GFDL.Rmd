...
```{r}
### Load GFDL-ESM4 data
picon <- read.csv('North_Sea_GFDL-ESM4_picontrol_annual_1601_2100.csv', header = TRUE)
hist <- read.csv('North_Sea_GFDL-ESM4_historical_annual_1850_2014.csv', header = TRUE)
ssp126 <- read.csv('North_Sea_GFDL-ESM4_ssp126_annual_2015_2100.csv', header = TRUE)
ssp585 <- read.csv('North_Sea_GFDL-ESM4_ssp585_annual_2015_2100.csv', header = TRUE)
...
species_names <- c("Sprat","Sandeel","N.pout","Herring","Dab","Whiting","Sole","Gurnard","Plaice","Haddock","Cod","Saithe" ) # to match case with therMizer parameters
