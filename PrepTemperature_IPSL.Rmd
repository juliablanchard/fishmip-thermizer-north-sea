...
author: "Modifed by julia.blanchard@utas.edu"
date: "2/9/2020"
output: 
  html_document:
    toc: yes
...
[Modified from Woodworth- Jefcoats' Hawaii Longline example]
...
```{r}
### Load IPSL-CM6A-LR data - changed to North_Sea
picon <- read.csv('North_Sea_IPSL-CM6A-LR_picontrol_annual_1601_2100.csv', header = TRUE)
hist <- read.csv('North_Sea_IPSL-CM6A-LR_historical_annual_1850_2014.csv', header = TRUE)
ssp126 <- read.csv('North_Sea_IPSL-CM6A-LR_ssp126_annual_2015_2100.csv', header = TRUE)
ssp585 <- read.csv('North_Sea_IPSL-CM6A-LR_ssp585_annual_2015_2100.csv', header = TRUE)
...
realm_names <- c("Sprat","Sandeel","N.pout","Herring","Dab","Whiting","Sole","Gurnard","Plaice","Haddock","Cod","Saithe" ) # to match case with therMizer parameters
